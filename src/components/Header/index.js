...
import { faSquareCaretDown, faBell, faStickyNote } from "@fortawesome/free-regular-svg-icons"

import styles from "./header.module.scss"
import logo from './../../assets/image/logo/Logo_SoCook_vertical_3.png'
import avatar from './../../assets/image/login/pexels-daria-shevtsova-704971.jpg'
          ...
          <div className='col-12 col-md'>
            <div className={styles.headerLeft}>
                <div className={styles.headerLeft__Logo}>
                  <img src={logo} alt='socook logo' className={styles.logoImage} />
                </div>
                <div className={styles.headerLeft__Search}>
                  <form className={styles.formSearch}>
                    <input type='text' className={styles.formSearch__Input} />
                    <button className={styles.formSearch__Btn}>
                      <FontAwesomeIcon icon={faMagnifyingGlass} className={styles.formSearch__Icon} />
                    </button>
                  </form>
                </div>
            </div>
              ...
              <div className={styles.feature}>
                <div className={styles.featureItem} onClick={hanlePopup}>
                  <div className={styles.featureItem__IconBox}>
                    <FontAwesomeIcon icon={faSquareCaretDown} className={styles.featureItem__Icon} />
                  </div>
                  <div className={`${styles.popUp} ${styles.popUp__Auto} ${styles.popUp__Square}`}>
                    <Link to='/login' className={ styles.popUp__SettingItem } onClick={ removeUserSession }>
                      <div className={styles.popUp__SettingIcon}>
                        <FontAwesomeIcon icon={faRightFromBracket} />
                      </div>
                      <div className={styles.popUp__SettingContent}>
                        <h5 className={`${styles.popUp__SettingTitle} m-0`}>Đăng xuất</h5>
                      </div>
                    </Link>
                    <Link to='/login' className={ styles.popUp__SettingItem } onClick={ removeUserSession }>
                      <div className={styles.popUp__SettingIcon}>
                ...
                <div className={styles.featureItem} onClick={hanlePopup}>
                  <div className={styles.featureItem__IconBox}>
                    <FontAwesomeIcon icon={faBell} className={styles.featureItem__Icon} />
                  </div>
                    ...
                    <a to='#' className={ styles.popUp__Item }>
                      ...
                      <div className={styles.popUp__Message}>
                        <p className={styles.popUp__MessageContent}>
                          ...
                          Hãy nấu một món ăn để tăng thêm niềm vui nào nào.
                        </p>
                      </div>
                    </a>
                  </div>
                ...
                <div className={styles.featureItem} onClick={hanlePopup}>
                  <div className={styles.featureItem__IconBox}>
                    <FontAwesomeIcon icon={faStickyNote} className={styles.featureItem__Icon} />
                  </div>
