  ...
  useEffect(() => {
    ...
    if(accessToken) {
      ...
      .catch(function(err) {
        ...
        if (!err?.response) setMessageErr('Server không phản hồi. Vui lòng thử lại sau.');
        else if(!err.response.messageCode === 3) setMessageErr('Có vẻ link đã hết hạn. Vui lòng thử lại sau.')
  ...
  function LoadingComponent() {
    return (
      <React.Fragment> 
        ...
        <div className="snippet d-flex justify-content-center" data-title=".dot-flashing">
          <div className="stage">
