...
const ActiveEmail = () => {
  ...
  function ModalActive({children}) {  
    ...
    return (
      <Modal show={show} onHide={handleClose} centered dialogClassName='rounded-3rem'>
    ...
    return (
      <div className="d-flex flex-column align-items-center">
        ...
        <p className="form-auth__text-gray pb-3 text-center">
          ...
          <span className={'textlink-blue' + (validClick ? '' : 'text-muted')} onClick={handleClick}>
