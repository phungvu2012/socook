  ...
  return (
    <div className="form-box">
      <form onSubmit={handleSubmit} className="form-auth">
        ...
        <div
          className={
            "form-auth__input-field " + (!validName && user && "invalid")
          }
        >
          ...
          <FontAwesomeIcon
            ...
            className={
              ...
              (user && !validName ? " form-auth__danger-icon" : "d-none")
            }
          />
        </div>
        <div className="form-auth__text text-start">
          <p
            id="uidnote"
            className={
              "text-danger m-0 " + (user && !validName ? "" : "d-none")
            }
          >
            Tên tài khoản phải có 4 đến 24 ký tự
            <br />
            Phải bắt đầu bằng chứ và không chứa kỹ tự đặc biệt
            <br />
          </p>
        </div>
        <div
        ...
        <div
          className={
            "form-auth__input-field " + (!validPwd && pwd ? "invalid" : "")
          }
        >
          ...
          <FontAwesomeIcon
            ...
            className={
              "form-auth__input-icon " +
              (pwd && !validPwd ? " form-auth__danger-icon" : "d-none")
            }
          />
        </div>
        <div className="form-auth__text text-start">
          <p
            className={"text-danger m-0 " + (pwd && !validPwd ? "" : "d-none")}
          >
            Mật khẩu trên 8 ký tự
            <br />
            Phải có ít nhất 1 chữ cái thường, 1 chữ cái hoa, 1 số và 1 ký tự đặc
            biệt(<span aria-label="exclamation mark">!</span>{" "}
            <span aria-label="at symbol">@</span>{" "}
            <span aria-label="hashtag">#</span>{" "}
            <span aria-label="dollar sign">$</span>{" "}
            <span aria-label="percent">%</span>)<br />
          </p>
        </div>
        <div
          className={
        ...
        >
          ...
          <FontAwesomeIcon
            ...
            className={
              "form-auth__input-icon " +
              (matchPwd && !validMatch ? " form-auth__danger-icon" : "d-none")
            }
          />
        </div>
        <div className="form-auth__text text-start">
          <p
            className={
              "text-danger m-0 " + (matchPwd && !validMatch ? "" : "d-none")
            }
          >
            Mật khẩu không khớp
          </p>
        ...
        <button
          disabled={
            loading || !validName || !validEmail || !validPwd || !validMatch
          }
